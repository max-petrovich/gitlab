...
| `registry`              | Package registry configuration to [publish](https://docs.gitlab.com/ee/user/packages/generic_packages/index.html#publish-a-package-file) the asset to the generic package registry. If not defined, the asset will be uploaded directly into the release and [cannot be retrieved](https://gitlab.com/gitlab-org/gitlab/-/issues/25838) using API. Can be `String` with package name or `Object` with the following parameters: | -                                    |
| `registry.package_name` | **Optional.** The package name. It can contain only lowercase letters (a-z), uppercase letter (A-Z), numbers (0-9), dots (.), hyphens (-), or underscores (_).                                                                                                                                                                                                                                                                  | -                                    |

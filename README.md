...
| `package_registry` | The name of the package to [publish](https://docs.gitlab.com/ee/user/packages/generic_packages/index.html#publish-a-package-file) the asset to the generic package registry. If not defined, the asset will be uploaded directly into the release and [cannot be retrieved](https://gitlab.com/gitlab-org/gitlab/-/issues/25838) using API. | -                                    |
